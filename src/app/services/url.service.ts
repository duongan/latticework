...
export class UrlService {
  ...
  private urls = {
    ...
    activityInfo: `${this.host}/amber/activity_event_list/{profileId}?offset={offset}&limit={limit}`,
    appProfile: `${this.host}/clientapp/profile/{profileId}`,
    appActivityInfo: `${this.host}/clientapp/activity_event_list/{profileId}?offset={offset}&limit={limit}`,
